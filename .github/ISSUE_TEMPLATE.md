Submit a new issue only if you are sure it is a missing feature or a bug. Otherwise use the [discussion section](https://github.com/komoot/photon/discussions).
